...
class NouveauPatient {
  ...
  affichageNouveauPatientTempsReel() {
    return _firebaseFirestore.collection('nouveau patient').snapshots();
  }

  Future<NouveauPatient?> affichageNouveauPatient(String matricule) async {
    final doc = _firebaseFirestore.collection('nouveau patient').doc(matricule);
